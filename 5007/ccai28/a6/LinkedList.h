...
//
// - is invalid and cannot be used (but must be freed) if there was only one element in the list
// - points to the successor of the deleted node, if there is one.
// - points to the predecessor of the deleted node, if the iterator was pointing at
//   the tail.
//
