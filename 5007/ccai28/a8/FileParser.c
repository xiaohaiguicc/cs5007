...
Index BuildMovieIndex(LinkedList movies, enum IndexField field_to_index) {
  // TODO(chenxi cai): How big to make this hashtable?
  ...
  while (LLIterHasNext(iter)) {
    ...
    if (result == 2) {
      // TODO(chenxi cai): What to do if there is a collision?
